...
if (process.env.GITHUB_STEP_SUMMARY) {
  ...
  const lines = [
    ...
    `- New notifications / duplicate suppressions: **${Number(result.newMatches) || 0} / ${coverage.duplicatesSuppressed || 0}**`,
  ...
  lines.push('', 'The `portal-coverage` artifact contains the full company-by-company JSON and CSV report.');
